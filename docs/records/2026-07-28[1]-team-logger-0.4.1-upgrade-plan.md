> **Состояние на 2026-08-24:** Сделано и смержено в main (коммиты 1fb0bd7,
> 91efe76, 81a140f); flutter_team_logger 0.4.0 с team_logger 0.4.1
> опубликован на pub.dev 2026-07-28.
> **Что это:** план перехода team_logger 0.3.0 → 0.4.1 (миграция API, бамп
> версии пакета до 0.4.0).
