...
class Logs2 extends StatefulWidget {
  ...
  @override
  State<Logs2> createState() => _Logs2State();
}

class _Logs2State extends State<Logs2> {
  ...
  late final int _initialLogsCount;
  late int _actualLogsCount;
  ...
  void initState() {
    ...
    // _listKey.currentState!.removeAllItems(builder);

    _actualLogsCount = _initialLogsCount = widget.logStorage.count;
  ...
  @override
  void didUpdateWidget(covariant Logs2 oldWidget) {
  ...
  void _subscribe() {
    _subscription = widget.logStorage.onChanged.listen(_logsChanged);
  }
  ...
  void _logsChanged(LogStorageEvent event) {
    ...
    switch (event) {
      case LogStorageAdd():
        listState.insertItem(0, duration: widget.slidingDuration);
        _actualLogsCount++;
                    ...
                    child: Padding(
                      ...
                      child: ColoredBox(
                        ...
                        child: AnimatedList(
                          ...
                          initialItemCount: _initialLogsCount,
...
class LogItem2 extends StatefulWidget {
  ...
  @override
  State<LogItem2> createState() => _LogItem2State();
}

class _LogItem2State extends State<LogItem2> with TickerProviderStateMixin {
  ...
  String? _buildStackTrace(Log log, LogLevelTheme theme) {
    final stackTraceBox =
        _stackTracerBuilder(widget.log, theme, LogItem2._row, null);
